...
const checkInitialized = (req: Request, res: Response, next: Function) => {
  if (!aiService.isInitialized()) {
    return res.status(503).json({ 
      ...
      message: 'The AI service is still starting up. Please try again in a moment.' 
    });
  }
  next();
};
 ...
 */
router.post('/sessions', checkInitialized, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/sessions/:sessionId', checkInitialized, (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/players/:playerId/sessions', checkInitialized, (req: Request, res: Response) => {
  try {
 ...
 * Delete a session
 */
router.delete('/sessions/:sessionId', checkInitialized, (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
 ...
 * Roll dice
 */
router.post('/dice/roll', checkInitialized, async (req: Request, res: Response) => {
  try {
 ...
 * Update status tags
 */
router.put('/status-tags', checkInitialized, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/status-tags/:entityId', checkInitialized, async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/knowledge', checkInitialized, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/knowledge', checkInitialized, async (req: Request, res: Response) => {
  try {
